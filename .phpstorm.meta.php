...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'steadfast-courier.base_url' => 'string',
            'steadfast-courier.api_key' => 'string',
            'steadfast-courier.secret_key' => 'string',
            'steadfast-courier.content_type' => 'string',
            ...
            'filesystems.links./var/www/devlopment/personal/naafiun.com/laravel-11-pingcrm/public/storage' => 'string',
            'scout.driver' => 'string',
            'scout.prefix' => 'string',
            'scout.queue' => 'boolean',
...
'activitylog.activity_model','activitylog.table_name','activitylog.database_connection','database.default','database.connections.sqlite.driver',
...
'database.redis.cache.port','database.redis.cache.database','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'mail.markdown.theme','mail.markdown.paths','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'steadfast-courier.base_url','steadfast-courier.api_key','steadfast-courier.secret_key','steadfast-courier.content_type','auth.defaults.guard',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','app.name','app.env','app.debug',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','queue.default',
...
'queue.failed.database','queue.failed.table','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'cache.prefix','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'view.compiled','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.throw',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/devlopment/personal/naafiun.com/laravel-11-pingcrm/public/storage','scout.driver','scout.prefix',
...
'scout.typesense.model-settings','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddQueries.maximum_number_of_collected_queries',
...
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.cart.','v1.cart.','v1.cart.','v1.cart.','v1.cart.',
'v1.cart.','v1.cart.','v1.cart.','v1.cart.','v1.cart.',
'v1.cart.','v1.cart.','v1.cart.','v1.cart.','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','v1.','v1.','v1.',
...
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','v1.','v1.','v1.',
'v1.','v1.','login','login.store',
'logout','dashboard','users','users.create','users.store',
'users.edit','users.update','users.destroy','users.restore','organizations',
'organizations.create','organizations.store','organizations.edit','organizations.update','organizations.destroy',
'organizations.restore','contacts','contacts.create','contacts.store','contacts.edit',
'contacts.update','contacts.destroy','contacts.restore','reports','image',);
        registerArgumentsSet('views', 
'app','mail.admin','mail.contact','mail.contact-text','mail.layout.app',
'mail.layout.includes.email_footer','mail.layout.includes.email_header','mail.signup_otp','mail.welcome_mail','laravel-exceptions-renderer::components.card',
...
'SESSION_PATH','SESSION_DOMAIN','MEMCACHED_HOST','REDIS_HOST','REDIS_PASSWORD',
...
'VITE_PUSHER_APP_CLUSTER','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_KEY',);
